    ...
    return (
        <div className="min-h-screen bg-[#07090d] text-white">
            <aside className="fixed inset-y-0 left-0 z-50 hidden w-64 border-r border-white/10 bg-[#090c12] p-5 lg:block">
                        ...
                        ([
                            ...
                            >
                                ...
                                {id ===
                                    ...
                                    newCount >
                                        0 && (
                                        <span className="ml-auto rounded-full bg-white px-2 py-0.5 text-[10px] text-black">
                                            {
                                                newCount
                                            }
                                        </span>
                ...
                <button
                    onClick={logout}
                    className="absolute bottom-5 left-5 right-5 flex items-center gap-3 rounded-xl px-4 py-3 text-sm font-bold text-white/45 hover:bg-white/5 hover:text-white"
                >
                    <LogOut
                        size={18}
                    />
            ...
            <main className="lg:pl-64">
                <header className="sticky top-0 z-30 flex min-h-20 items-center justify-between border-b border-white/10 bg-[#07090d]/90 px-5 backdrop-blur md:px-8">
                    ...
                    <div className="hidden lg:block">
                        <p className="text-xs font-black uppercase tracking-[.25em] text-[#0088ff]">
                            LKC Media CMS
                        </p>
                    </div>
                ...
                <div className="mx-auto max-w-7xl p-5 md:p-8">
                    {notice && (
                        <div className="fixed bottom-6 right-6 z-[100] rounded-xl border border-white/10 bg-[#121822] px-5 py-3 text-sm shadow-2xl">
                            {notice}
                        </div>
                    )}
                                            ...
                                            <div className="flex flex-col gap-5 md:flex-row md:justify-between">
                                                <div>
                                                    <div className="flex items-center gap-3">
                                                        ...
                                                        <span className="rounded-full bg-white/5 px-3 py-1 text-xs uppercase text-white/50">
                                                            {
                                                                booking.shoot_type
                                                            }
                                                            {booking.sport
                                                    ...
                                                    <a
                                                        ...
                                                        className="mt-2 block text-sm text-[#58afff]"
                                                    >
                                                        {
                                                            booking.email
                                                        }
                                ...
                                <div className="flex flex-col gap-4 xl:flex-row xl:items-end">
                                    ...
                                    <div>
                                        ...
                                        <select
                                            ...
                                            className="mt-2 block rounded-xl border border-white/10 bg-black/30 px-4 py-3 text-sm font-bold"
                                        >
                                            <option value="sports">
                                                Sports
                                            </option>
                                    ...
                                    <button
                                        ...
                                        className="rounded-xl bg-[#0088ff] px-5 py-3 font-black disabled:opacity-50"
                                    >
                                        <Plus
                                            className="mr-2 inline"
                                            size={
                                            ...
                                            {albums.map(
                                                (
                                                    ...
                                                    <span
                                                        ...
                                                        className="rounded-full border border-white/10 bg-white/[0.03] px-3 py-2 text-xs font-bold text-white/60"
                                                    >
                                                        {
                                                            album.name
                                                        }
                        ...
                        <>
                            ...
                            <section className="mt-8 rounded-3xl border border-white/10 bg-[#0d1118] p-6">
                                ...
                                <div className="mt-5 grid gap-4 md:grid-cols-2">
                                    ...
                                    <label className="text-xs font-bold text-white/45 md:col-span-2">
                                        TAGLINE
                                    ...
                                    (
                                        ...
                                        >
                                            <div className="flex items-center gap-2">
                                                <span className="rounded-lg bg-white/5 px-3 py-1 text-[11px] font-black uppercase tracking-wider text-white/40">
                                                    {
                                                ...
                                                <button
                                                    ...
                                                    className="ml-auto rounded-lg p-2 hover:bg-white/5"
                                                >
                                                    {section.is_visible ? (
                                                        <Eye
                                                            size={
                                            ...
                                            <div className="mt-4 grid gap-3">
                                                ...
                                                <input
                                                    ...
                                                    placeholder="Small heading / subtitle"
                                                    value={
                                                        section.subtitle
                                                    }
                                                    onChange={(
                                                ...
                                                <input
                                                    ...
                                                    placeholder="Image URL (upload in Media Library, then paste here)"
                                                    value={
                                                        section.image_url ||
                                                        ""
                                                    }
