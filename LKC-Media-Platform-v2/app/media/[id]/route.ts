...
export async function GET(
    ...
    try {
        ...
        /*
         * Public media access is controlled by
         * is_visible.
         *
         * is_private only enables the separate
         * PIN-protected client experience. An album
         * may therefore be both public and client-enabled.
         */
        const {
            data: album,
            error: albumError,
